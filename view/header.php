                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="../view/visuJogGen.php">Pesquisar por Gênero</a></li>
                            <li><a class="dropdown-item" href="../view/visuJogGen.php">Pesquisar por Código</a></li>
                            <li><a class="dropdown-item" href="../view/visuJogNom.php">Pesquisar por Nome</a></li>
                            <li><a class="dropdown-item" href="../view/visuJogGen.php">Pesquisar por Plataforma</a></li>
                        </ul>
                    </li>
                </ul>
                <form class="d-flex">
